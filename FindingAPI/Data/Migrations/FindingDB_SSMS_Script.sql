...
CREATE TABLE [Confessions] (
    ...
    CONSTRAINT [FK_Confessions_Users_AuthorId] FOREIGN KEY ([AuthorId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Confessions_Users_TargetUserId] FOREIGN KEY ([TargetUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
...
CREATE TABLE [Reports] (
    ...
    CONSTRAINT [FK_Reports_Users_ReportedUserId] FOREIGN KEY ([ReportedUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
...
CREATE TABLE [InteractionRequests] (
    ...
    CONSTRAINT [FK_InteractionRequests_Users_ConfessorId] FOREIGN KEY ([ConfessorId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_InteractionRequests_Users_TargetUserId] FOREIGN KEY ([TargetUserId]) REFERENCES [Users] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20260818153113_InitialCreate', N'9.0.1');
